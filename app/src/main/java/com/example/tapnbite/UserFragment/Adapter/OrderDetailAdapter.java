...
public class OrderDetailAdapter extends RecyclerView.Adapter<OrderDetailAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (!order.getFoodItems().isEmpty()) {
            ...
            //PRICE
            holder.tvPrice.setText(order.getFoodItems().get(0).getPrice());
            //TOTAL ITEM
            ...
            //CANTEEN
            holder.tvCanteenLoc.setText(order.getFoodItems().get(0).getCanteeNo());
        } else {
...
//            holder.tvPrice.setText("0.00");
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            tvCanteenLoc = itemView.findViewById(R.id.tvCanteen);
